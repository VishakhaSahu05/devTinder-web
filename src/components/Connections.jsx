...
const Connections = () => {
  ...
  if (connections.length === 0) return <h1 className="text-center text-xl mt-10">No Connections Found</h1>;
      ...
      <div className="flex flex-col items-center gap-4">
        {connections.map((connection, index) => {
          ...
          return (
            <div
              key={index}
              className="w-80 p-4 border rounded-lg bg-base-300 shadow-md flex gap-4 items-center"
            >
              <img
                alt="photo"
